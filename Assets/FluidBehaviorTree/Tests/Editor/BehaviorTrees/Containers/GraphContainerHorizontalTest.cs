...
namespace FluidBehaviorTree.Tests.Editor.BehaviorTrees.Containers
{
        ...
        public class AddBoxMethod
        {
            public class DefaultTests : GraphContainerHorizontalTest
            {
                ...
                public void It_should_stack_multiple_child_containers_side_by_side()
                {
                    for (var i = 0; i < 3; i++)
                    {
                        IGraphBox child = A.GraphBoxStub().WithSize(100, 50).Build();
                        _container.AddBox(child);
                    }

                    for (var i = 0; i < _container.ChildContainers.Count; i++)
                    {
                        IGraphBox child = _container.ChildContainers[i];
            ...
            public class SettingHeight : GraphContainerHorizontalTest
            {
                ...
                {
                    IGraphBox childBoxAlt = A.GraphBoxStub().WithSize(0, 100).Build();
                ...
                {
                    IGraphBox childBoxAlt = A.GraphBoxStub().WithSize(0, 20).Build();
