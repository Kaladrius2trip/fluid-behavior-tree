...
namespace FluidBehaviorTree.Runtime.BehaviorTree.Builder
{
    public class BehaviorTreeBuilder
    {
        private readonly BehaviorTree _tree;
        private readonly List<ITaskComposite> _pointers = new List<ITaskComposite>();
        ...
        private ITaskComposite PointerCurrent
        {
            get
            {
        ...
        public BehaviorTreeBuilder ParentTask<P>(string name)
            where P : ITaskComposite, new()
        {
        ...
        public BehaviorTreeBuilder AddNodeWithPointer(ITaskComposite task)
        {
            AddNode(task);
            _pointers.Add(task);
